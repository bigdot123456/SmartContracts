...
import "./TimePlatform.sol";

contract TimeAssetInterface {
...
contract TimeAssetProxy is ERC20 {
    // Assigned platform, immutable.
    TimePlatform public chronoBankPlatform;
     ...
     * @return success.
     */
    function init(TimePlatform _chronoBankPlatform, string _symbol, string _name) returns(bool) {
...
function stringToBytes32(string memory source) returns (bytes32 result) {
     ...
     */
    function _getAsset() internal returns(TimeAssetInterface) {
        return TimeAssetInterface(getVersionFor(msg.sender));
    }
